...
public class CuraKeywords {
	...
	public void TestKeywords() {
		...
		WebUI.setText(findTestObject('Object Repository/LoginOR/Page_CURA Healthcare Service/input_username'), GlobalVariable.Username)

		WebUI.setText(findTestObject('Object Repository/LoginOR/Page_CURA Healthcare Service/input_password'), GlobalVariable.Password)
