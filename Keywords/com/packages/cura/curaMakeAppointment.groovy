...
public class curaMakeAppointment {
	...
	public void makeApp() {
		...
		WebUI.click(findTestObject('Object Repository/MakeAppointmentOR/Page_CURA Healthcare Service/input_hospital_readmission'))

		WebUI.click(findTestObject('Object Repository/MakeAppointmentOR/Page_CURA Healthcare Service/input_programs'))
		...
		WebUI.setText(findTestObject('Object Repository/MakeAppointmentOR/Page_CURA Healthcare Service/textarea_comment'), 'TEst make Appointment')
