...
WebUI.click(findTestObject('Object Repository/LoginOR/Page_CURA Healthcare Service/h2_Make Appointment'))

WebUI.verifyCheckpoint(findCheckpoint('Checkpoints/Cura_Login_Checkpoint_01'), true)
