...
CustomKeywords.'com.packages.cura.curaMakeAppointment.makeApp'()
...
WebUI.verifyElementText(findTestObject('Object Repository/HistoryOR/Page_CURA Healthcare Service/p_Seoul CURA Healthcare Center'), 
    'Seoul CURA Healthcare Center')

WebUI.click(findTestObject('Object Repository/HistoryOR/Page_CURA Healthcare Service/div_29012024                               _ecd118'))
